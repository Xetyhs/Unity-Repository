...
public class Player : MonoSingleton<Player>
{
    ...
    {
        _score += score * _playerData.IngameScoreMultiplier + (Shield.Instance.GetKillCount() - Shield.Instance.comboTrigger);
    }
